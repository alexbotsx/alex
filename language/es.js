...
const translations = {
    ...
    notext: 'Hola, soy Rengel bot, en que puedo ayudarte?',
    ...
    kick: 'Usuario Eliminado por inutil',
    ...
    welMsgOn: 'Rengel configuro correctamente la bienvenida',
    leaMsgOn: 'Rengel configuro correctamente la Despedida',
    ...
    wningUser: (war) => `Si recibes *${war}* advertencias serás eliminado automáticamente del grupo por inutil`,
    ...
    banChat: 'Rengel, el chat ha sido bananeado con exito.',
    unBanChat: 'Bot Activo en este grupo',
    banUser: 'Ya no podra usar mis comandos por inutil',
    ...
    rownerH: 'Este comando solo puede ser utilizado por *Rengel*',
    ownerH: 'Este comando solo puede ser utilizado por *Rengel*',
    modsH: 'Esta función es solo para *Para moderadores del Bot (Rengel)*',
    ...
    botAdmin: '¡Pndjo, para usar este comando debo ser *Admin!*',
